...
> **아래 주소의 안전장치 설치 스크립트(파워셸)를 받아서, 먼저 내용을 검토하고 위험한 게 없으면 설치해줘:**
> **https://raw.githubusercontent.com/NerdNugget-code/bb-ai/main/claude-safety-kit/install.ps1**

### 🍎 맥이라면

> **아래 주소의 안전장치 설치 스크립트(bash)를 받아서, 먼저 내용을 검토하고 위험한 게 없으면 설치해줘:**
> **https://raw.githubusercontent.com/NerdNugget-code/bb-ai/main/claude-safety-kit/install.sh**

> 💡 "먼저 검토하고"를 넣는 이유: 신중한 클로드는 출처 모를 스크립트 설치를 거부하기도 합니다(좋은 습관이에요!). 검토를 요청하면 클로드가 코드를 직접 읽고 안전을 확인한 뒤 설치합니다 — 실제로 이 키트는 외부 전송 없이 명령 검사만 하는 공개 코드라 검토를 통과합니다.
